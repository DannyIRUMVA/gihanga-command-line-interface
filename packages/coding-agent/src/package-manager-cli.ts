...
function printConfigCommandHelp(): void {
	console.log(`${chalk.bold("Imikoreshereze:")}
  ${CONFIG_COMMAND_USAGE}

Fungura TUI y'igenamiterere ry'umutungo kugira ngo wemere cyangwa uhagarike umutungo w'amapakeji.
Iyo nta -l, itangirira mu igenamiterere rusange (~/${CONFIG_DIR_NAME}/agent/settings.json).
Kanda Tab muri TUI kugira ngo uhinduranye hagati y'igenamiterere rusange n'irya poroje.

Amahitamo:
  -l, --local       Hindura ibyihariye bya poroje (${CONFIG_DIR_NAME}/settings.json)
  -a, --approve     Izera dosiye zo muri poroje kuri iri tegeko hamwe na -l
  -na, --no-approve Irengagize dosiye zo muri poroje kuri iri tegeko hamwe na -l
`);
}
...
Injiza ipakeji maze uyongere mu igenamiterere.

Amahitamo:
  -l, --local       Injiza imbere muri poroje gusa (${CONFIG_DIR_NAME}/settings.json)
  -a, --approve     Izera dosiye zo muri poroje kuri iri tegeko
  -na, --no-approve Irengagize dosiye zo muri poroje kuri iri tegeko
...
Kuramo ipakeji n'isoko yayo mu igenamiterere.
Izina risimbura: ${APP_NAME} uninstall <source> [-l]

Amahitamo:
  -l, --local       Kuramo mu igenamiterere rya poroje (${CONFIG_DIR_NAME}/settings.json)
  -a, --approve     Izera dosiye zo muri poroje kuri iri tegeko
  -na, --no-approve Irengagize dosiye zo muri poroje kuri iri tegeko
...
Vugurura Gihanga n'amapakeji yinjijwe.

Amahitamo:
  --self                  Vugurura Gihanga gusa (default iyo nta target yatanzwe)
  --extensions            Vugurura amapakeji yinjijwe gusa
  --all                   Vugurura Gihanga n'amapakeji yinjijwe
  --extension <source>    Vugurura ipakeji imwe gusa
  -a, --approve           Izera dosiye zo muri poroje kuri iri tegeko
  -na, --no-approve       Irengagize dosiye zo muri poroje kuri iri tegeko
  --force                 Ongera winjize Gihanga nubwo version iriho ari iya vuba
...
Erekana amapakeji yinjijwe ari mu igenamiterere ry'umukoresha n'irya poroje.
