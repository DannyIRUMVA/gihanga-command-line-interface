 ...
 * Encodes cwd into a safe directory name under the user agent sessions directory.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses the default user agent sessions directory.
	 */
