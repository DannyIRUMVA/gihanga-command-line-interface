...
export function getPackageDir(): string {
	...
	const envDir = process.env.GIHANGA_PACKAGE_DIR || process.env.PI_PACKAGE_DIR;
	if (envDir) {
...
export const CONFIG_DIR_NAME: string = pkg.piConfig?.configDir || ".gihanga";
export const VERSION: string = pkg.version || "0.0.0";

// e.g., GIHANGA_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
...
const DEFAULT_SHARE_VIEWER_URL = "https://console.upskillsafrica.org";

/** Get the share viewer URL for a gist ID */
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.GIHANGA_SHARE_VIEWER_URL || process.env.PI_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.gihanga/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.gihanga/agent/) */
