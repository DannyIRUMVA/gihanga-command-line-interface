...
Content`,
		...
		it("should auto-discover root markdown skills from project config skill dirs", async () => {
...
Content`,
	...
	describe("auto-discovered skill metadata", () => {
		it("should use the agent dir as baseDir for user agent-dir skills", async () => {
		...
		it("should use the project config dir as baseDir for project config skills", async () => {
	...
	describe(".agents/skills auto-discovery", () => {
		...
		it("should dedupe user skill entries when the agent skills dir is a symlink to ~/.agents/skills", async () => {
			const previousHome = process.env.HOME;
			process.env.HOME = tempDir;
	...
	describe("settings source normalization", () => {
		...
		it("should store project local packages relative to project config settings base", () => {
